...
class Main(AVGApp):   
    ...
    def init(self):
        self._gameOver = True
        g_player.getTestHelper().fakeKeyEvent(avg.KEYDOWN, 17, 116, "t", 116, 0)
    ...
    def endGame(self):
        ...
        self.parentNode.appendChild(self.victoryLeft)
        self.parentNode.appendChild(self.victoryRight)
        ...
        avg.LinearAnim(self.victoryScoreRight,"opacity", 9000, 0, 1).start()
