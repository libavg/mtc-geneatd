...
class Keyboard(object): 
    ...
    def showKeyBoard(self, parentNode, showPlayer1, showPlayer2):
        ...
        if (self.up1 and self.up2):
            ...
            highscoreDiv = avg.DivNode(pos=(0,0), size=(util.width, util.height), parent=parentNode)
            ...
            self.back.setEventHandler(avg.CURSORDOWN, avg.TOUCH or avg.MOUSE, backClick);
            self.back.setEventHandler(avg.CURSOROVER, avg.TOUCH or avg.MOUSE, lambda event : glow(event, self.back));
        ...
        def closeKeyboard():
            ...
            if (self.up1 and self.up2 and not self.highscoreComingUp2):
                ...
                highscoreDiv = avg.DivNode(pos=(0,0), size=(util.width, util.height))
        ...
        def placeKeyNode(parentNode, x, y, angle, char, id):
            ...
            keyNodeDiv.side = id
            keyNodeDiv.setEventHandler(avg.CURSORUP,avg.TOUCH or avg.MOUSE, lambda event : keyUp(keyNodeDiv.char, keyNodeDiv.side))
        ...
        def placeBackNode(parentNode, x, y, angle, id):
            keyNodeDiv = avg.DivNode(pos=(x,y), parent=parentNode)
            keyNodeDiv.side=id
            keyNodeDiv.setEventHandler(avg.CURSORUP,avg.TOUCH or avg.MOUSE, lambda event : keyUp("BACK", keyNodeDiv.side))
        ...
        def placeUpNode(parentNode, x, y, angle, id):
            keyNodeDiv = avg.DivNode(pos=(x,y), parent=parentNode)
            keyNodeDiv.side = id
            keyNodeDiv.setEventHandler(avg.CURSORUP,avg.TOUCH or avg.MOUSE, lambda event : shift(keyNodeDiv.side))
        ...
        def placeenterNode(parentNode, x, y, angle, id):
            keyNodeDiv = avg.DivNode(pos=(x,y), parent=parentNode)
            keyNodeDiv.side = id
            keyNodeDiv.setEventHandler(avg.CURSORUP,avg.TOUCH or avg.MOUSE, lambda event : enterUp(keyNodeDiv.side))
        ...
        if showPlayer2:
            ...
            self.divRight = avg.DivNode(pos=(util.halfwidth,0), size=(util.halfwidth, util.height), parent=parentNode)
