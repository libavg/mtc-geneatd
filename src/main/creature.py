...
class Creature(object):      
    ...
    def __init__(self, g_player, team, enemy,  pos, layer, when, main, inActiveLayer, maxHitPoints = 8):
        ...
        self.creatureDiv.setEventHandler(avg.CURSORUP,avg.TOUCH or avg.MOUSE, self._mouseUp)
        self.creatureDiv.setEventHandler(avg.CURSOROUT,avg.TOUCH or avg.MOUSE, self._mouseUp)

        self.creatureDiv.setEventHandler(avg.CURSORDOWN, avg.TOUCH or avg.MOUSE, self.creatureCursorDown)
